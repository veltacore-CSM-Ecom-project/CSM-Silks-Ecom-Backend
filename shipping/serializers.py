...
class ShipmentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Shipment
        fields = ["id", "order", "order_number", "provider", "awb_number", "tracking_url", "status", "raw_payload", "events", "created_at", "updated_at"]
...
class ShipmentWriteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Shipment
        fields = ["order", "provider", "awb_number", "tracking_url", "status", "raw_payload", "event_location", "event_note"]
